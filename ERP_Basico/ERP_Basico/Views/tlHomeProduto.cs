...
namespace ERP_Basico.Views
{
    public partial class tlHomeProduto : Form
    {
        ...
        {
            ChamarTelaCadastro("Visualizar", RecuperarProduto());
        }
        ...
        {
            ChamarTelaCadastro("Alterar", RecuperarProduto());
        }
        ...
        private void ExcluirProduto()
        {
            ...
            if (produtoSelecionado != null)
            {
                    ...
                    MessageBoxIcon.Warning) == DialogResult.Yes)
                {
                    ...
                    if (produtoController.ApagarProduto(produtoSelecionado.IdProduto) > 0)
                    {
