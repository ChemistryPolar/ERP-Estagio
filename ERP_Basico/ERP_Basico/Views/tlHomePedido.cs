...
{
    public partial class tlHomePedido : Form
    {

        public string Tipo = null;
        public Pedido pedidoSelecao;
        private readonly string _roleDoFuncionario;

        public tlHomePedido(string role)
        {
            InitializeComponent();
        ...
        {
            ChamarTelaCadastro("Visualizar", RecuperarPedido());
        }
        ...
        {
            ChamarTelaCadastro("Alterar", RecuperarPedido());
        }
        ...
        private void PesquisarProduto()
        {
            ...
            dgvRegistros.DataSource = produtoController.PesquisarProdutoAll();
        ...
        {
            pedidoSelecao = RecuperarPedido();
            if (pedidoSelecao != null)
        ...
        private void ExcluirPedido()
        {
            ...
            Produto pedidoSelecionado = RecuperarPedido();
            ...
            if (pedidoSelecionado != null)
            {
                    ...
                    MessageBoxIcon.Warning) == DialogResult.Yes)
                {
                    ...
                    if (produtoController.ApagarProduto(pedidoSelecionado.IdProduto) > 0)
                    {
        ...
        #region ChamarTela
        public void ChamarTelaCadastro(string acao, Produto produto)
        {

            tlCadastProdut frm = new tlCadastProdut(acao, produto);
